...
<head>
  ...
  <title>Bendung Jenemarung</title>
                ...
                <div id="order_table">  
                     <table class="table table-bordered text-center">  
                          <tr>  
                               ...
                               <th colspan="2">Intake Primer Kanan</th>  
                               <th colspan="2">Intake Primer Kiri</th>
                          </tr>   
                          <tr>  
                               <th>TMA (cm)</th>  
                               <th>Debit (lt/det)</th> 
...
function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('tma_bp_jenemarung.' + (type || 'xlsx')));
    } 
 </script>  
 <script>
    function preview() {
...
document.getElementById("exportTableCSV").addEventListener("click", function(e){
    ...
    dl_anchor.download = "tma_bp_jenemarung.csv";
  ...
  function pdf() {
            html2canvas(document.getElementById('order_table'), {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("tma_bp_jenemarung.pdf");
                }
            });
        }
</script>
