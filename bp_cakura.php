                ...
                <div id="order_table">  
                     <table class="table table-bordered text-center">  
                          ...
                          <tr>  
                            ...
                            <?php
                            $url = 'https://scada-pamukkulu.com/conn_bp_cakura.php';
...
$('#myChart1').hide()
        ...
        async function getData() {
            const response = await fetch('https://scada-pamukkulu.com/conn_bp_cakura.php');
...
<script>
    //  getDatas();
        async function getDatas() {
            const response = await fetch('https://scada-pamukkulu.com/data_bp_cakura.json');
            // console.log(response);
            const data = await response.json();
            data.reverse();
            // console.log(data);
