                ...
                <div id="order_table">  
                     <table class="table table-bordered text-center">  
                          ...
                          <tr>  
                            ...
                            <?php
                            $url = 'http://localhost:8080/scada/conn_bp8.php';
...
$('#myChart1').hide()
        ...
        async function getData() {
            const response = await fetch('http://localhost:8080/scada/conn_bp8.php');
...
<script>
    //  getDatas();
        async function getDatas() {
            const response = await fetch('http://localhost:8080/scada/data_bp8.json');
            // console.log(response);
            const data = await response.json();
            data.reverse();
            // console.log(data);
